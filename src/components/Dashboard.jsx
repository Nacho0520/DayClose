...
// SEGURIDAD: TEST_ACCOUNT eliminado. isTestAccount llega como prop desde App.jsx,
// derivado de VITE_TEST_EMAIL (variable de entorno), nunca hardcodeado aquí.
...
function Dashboard({
  ...
  // SEGURIDAD: isTestAccount viene como prop desde App.jsx (derivado de VITE_TEST_EMAIL)
  // No hay ninguna referencia a un email hardcodeado en este componente.
