...
const PATREON_URL = "https://www.patreon.com/15618428/join";
...
export default function ProModal({ isOpen, onClose, user, onProActivated }) {
  ...
  const features = [
    ...
    {
      icon: BarChart2,
      text: t("pro_comparison_title") || "Estadísticas avanzadas",
    },
    ...
    try {
      ...
      if (!data?.success) {
        const errMap = {
          code_not_found:
            t("pro_code_invalid") ||
            "Código no válido. Compruébalo e inténtalo de nuevo.",
          code_already_used:
            t("pro_code_used") || "Este código ya ha sido usado.",
          code_expired:
            t("pro_code_expired") ||
            "Este código ha caducado. Contacta con soporte.",
        };
        setError(
          errMap[data?.error] ||
            t("pro_code_error") ||
                ...
                {step === "offer" ? (
                  <>
                    ...
                    <div className="bg-white/5 rounded-2xl p-4 mb-4 border border-white/10 space-y-2">
                      ...
                      {[
                        ...
                        t("pro_step_2") ||
                          "Recibirás un código único por email",
                        ...
                        >
                          <span className="text-violet-400 font-black mt-px shrink-0">
                            {i + 1}.
                          </span>
                    ...
                    <a
                      ...
                      className="w-full flex flex-col items-center justify-center gap-1 bg-gradient-to-r from-violet-600 to-indigo-600 text-white font-bold py-4 rounded-2xl text-base active:scale-95 transition-all shadow-lg shadow-indigo-500/30 mb-3"
                    >
                  ...
                  <div className="flex flex-col items-center py-6 gap-4">
                    ...
                    <p className="text-neutral-400 text-sm text-center">
                      {t("pro_activated_desc") ||
                        "Ya tienes acceso a todas las funciones Pro."}
                    </p>
                  </div>
                ) : (
                  /* ── Introducir código ── */
                  <>
                    ...
                    <p className="text-neutral-400 text-xs mb-4">
                      {t("pro_code_desc") ||
                        "Introduce el código que recibiste por email tras apoyar el proyecto en Ko-fi."}
                    </p>
                    ...
                    <input
                      ...
                      placeholder={
                        t("pro_code_placeholder") || "DAYCLOSE-PRO-XXXX-XXXX"
                      }
                    ...
                    >
                      {loading ? (
                        ...
                        <>
                          ...
                          {t("pro_activate_btn") || "Activar Pro"}
                        </>
                      )}
                    </button>
